...
function App() {
  ...
  const [codeAffiliate, setCodeAffiliate] = useState<string | null>(null);
 
  // missing lphie and heal
  ...
  const handleCodeSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      form.reset();
      setCodeAffiliate(result.affiliate);
  ...
  return (
    <div className="bg-orange-100 font-serif min-h-screen flex flex-col">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 items-start gap-1">
        ...
        {/*2nd form*/}
        <div className="w-[calc(100%-2rem)] max-w-xl mx-auto mt-2 p-4 sm:p-6 drop-shadow bg-slate-200 rounded-lg shadow-md border border-gray-200 self-stretch">
          ...
          <form className="mt-4 space-y-4" onSubmit={handleCodeSubmit}>
            ...
            {codeAffiliate && affiliateLogos[codeAffiliate.toLowerCase()] && (
              <div className="flex justify-center">
                <img
                  src={affiliateLogos[codeAffiliate.toLowerCase()]}
                  alt={`${codeAffiliate} logo`}
